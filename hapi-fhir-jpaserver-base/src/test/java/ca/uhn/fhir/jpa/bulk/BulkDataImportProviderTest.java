...
import org.apache.http.util.EntityUtils;  // DO NOT SUBMIT?
	...
	public void start() throws Exception {
        ...
        public void testSuccessfulInitiateBulkRequest_Post() throws IOException {
                ...
                post.setEntity(MultipartEntityBuilder.create()
                        .setBoundary("THIS_IS_THE_BOUNDARY")
                        .addTextBody(
                                "Patients",
...
//                        assertEquals("Wat", post.toString() + " \n\n\n " + response.toString());  // DO NOT SUBMIT
                        assertEquals("Wat", EntityUtils.toString(response.getEntity()));  // DO NOT SUBMIT
